...
export default function SiteHeader() {
  ...
  return (
    <header style={{ position: "sticky", top: "0", zIndex: "40", background: "rgba(244,240,232,.93)", backdropFilter: "blur(14px)", borderBottom: "1px solid rgba(26,22,20,.12)" }}>
      <div style={{ maxWidth: "1260px", margin: "0 auto", padding: "14px 32px", display: "flex", alignItems: "center", gap: "20px", flexWrap: "nowrap" }}>
        ...
        <nav style={{ display: "flex", gap: "2px", alignItems: "center", marginLeft: "auto", flexWrap: "wrap", justifyContent: "flex-end", flex: "1 1 auto", minWidth: "0" }}>
        ...
        <Link className="hv-ink" to="/contact" style={{ flex: "none", display: "inline-flex", alignItems: "center", gap: "9px", padding: "12px 20px", background: "#C0392F", color: "#F4F0E8", font: "600 13px Archivo", textDecoration: "none", borderRadius: "3px" }}>Get a free quote<span style={{ fontSize: "14px", lineHeight: "1" }} aria-hidden="true">→</span></Link>
      </div>
    </header>
  )
}

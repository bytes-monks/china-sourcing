...
export default function SiteCta() {
  return (
    <section style={{ background: "#C0392F", color: "#F4F0E8" }}>
      <div data-m="wrap fluid" style={{ maxWidth: "1260px", margin: "0 auto", padding: "72px 32px", display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(300px,1fr))", gap: "40px", alignItems: "center" }}>
        <div>
        ...
        <div data-m="cta-actions" style={{ display: "flex", gap: "14px", flexWrap: "wrap", justifyContent: "flex-end" }}>

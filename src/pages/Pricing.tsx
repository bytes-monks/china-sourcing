...
export default function Pricing() {
  return (
    ...
    <section style={{ maxWidth: "1260px", margin: "0 auto", padding: "52px 32px 24px", display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(300px,1fr))", gap: "20px", alignItems: "stretch" }}>
      <div style={{ background: "#FBF9F5", border: "1px solid rgba(26,22,20,.14)", padding: "34px", display: "flex", flexDirection: "column" }}>
        ...
        <div style={{ font: "400 52px/1 'Instrument Serif',serif", marginBottom: "8px" }}>5–8%</div>
      ...
      <div style={{ background: "#1A1614", color: "#F4F0E8", padding: "34px", display: "flex", flexDirection: "column", position: "relative" }}>
        ...
        <div style={{ font: "400 52px/1 'Instrument Serif',serif", marginBottom: "8px" }}>$1,900<span style={{ fontSize: "22px", color: "rgba(244,240,232,.55)" }}>/mo</span></div>
      ...
      <div style={{ background: "#FBF9F5", border: "1px solid rgba(26,22,20,.14)", padding: "34px", display: "flex", flexDirection: "column" }}>
        ...
        <div style={{ font: "400 52px/1 'Instrument Serif',serif", marginBottom: "8px" }}>Custom</div>
    ...
    <section style={{ maxWidth: "1260px", margin: "0 auto", padding: "36px 32px 80px", display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(320px,1fr))", gap: "20px" }}>
      ...
      <div style={{ background: "#E9E0CF", padding: "36px" }}>

...
export default function Faq() {
  ...
  // The rows stay <a href="#"> because the pixel gate compares computed styles
  ...
  return (
    ...
    <section data-m="wrap" style={{ maxWidth: "900px", margin: "0 auto", padding: "44px 32px 80px" }}>
      ...
      <div style={{ borderBottom: "1px solid rgba(26,22,20,.14)" }}>
        <a className="hv-red" href="#" role="button" id="faq-q-2" aria-expanded={open === 2} aria-controls="faq-a-2" onClick={toggle(2)} onKeyDown={onKey(2)} style={{ display: "flex", justifyContent: "space-between", gap: "24px", alignItems: "baseline", padding: "22px 0", textDecoration: "none", color: "#1A1614" }}>
      ...
      <div style={{ borderBottom: "1px solid rgba(26,22,20,.14)" }}>
        <a className="hv-red" href="#" role="button" id="faq-q-3" aria-expanded={open === 3} aria-controls="faq-a-3" onClick={toggle(3)} onKeyDown={onKey(3)} style={{ display: "flex", justifyContent: "space-between", gap: "24px", alignItems: "baseline", padding: "22px 0", textDecoration: "none", color: "#1A1614" }}>
      ...
      <div style={{ borderBottom: "1px solid rgba(26,22,20,.14)" }}>
        <a className="hv-red" href="#" role="button" id="faq-q-4" aria-expanded={open === 4} aria-controls="faq-a-4" onClick={toggle(4)} onKeyDown={onKey(4)} style={{ display: "flex", justifyContent: "space-between", gap: "24px", alignItems: "baseline", padding: "22px 0", textDecoration: "none", color: "#1A1614" }}>
      ...
      <div style={{ borderBottom: "1px solid rgba(26,22,20,.14)" }}>
        <a className="hv-red" href="#" role="button" id="faq-q-5" aria-expanded={open === 5} aria-controls="faq-a-5" onClick={toggle(5)} onKeyDown={onKey(5)} style={{ display: "flex", justifyContent: "space-between", gap: "24px", alignItems: "baseline", padding: "22px 0", textDecoration: "none", color: "#1A1614" }}>
      ...
      <div style={{ borderBottom: "1px solid rgba(26,22,20,.14)" }}>
        <a className="hv-red" href="#" role="button" id="faq-q-6" aria-expanded={open === 6} aria-controls="faq-a-6" onClick={toggle(6)} onKeyDown={onKey(6)} style={{ display: "flex", justifyContent: "space-between", gap: "24px", alignItems: "baseline", padding: "22px 0", textDecoration: "none", color: "#1A1614" }}>
      ...
      <div style={{ borderBottom: "1px solid rgba(26,22,20,.14)" }}>
        <a className="hv-red" href="#" role="button" id="faq-q-7" aria-expanded={open === 7} aria-controls="faq-a-7" onClick={toggle(7)} onKeyDown={onKey(7)} style={{ display: "flex", justifyContent: "space-between", gap: "24px", alignItems: "baseline", padding: "22px 0", textDecoration: "none", color: "#1A1614" }}>
      ...
      <div style={{ borderBottom: "1px solid rgba(26,22,20,.14)" }}>
        <a className="hv-red" href="#" role="button" id="faq-q-8" aria-expanded={open === 8} aria-controls="faq-a-8" onClick={toggle(8)} onKeyDown={onKey(8)} style={{ display: "flex", justifyContent: "space-between", gap: "24px", alignItems: "baseline", padding: "22px 0", textDecoration: "none", color: "#1A1614" }}>

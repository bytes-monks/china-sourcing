    ...
    <section data-m="wrap" style={{ maxWidth: "1260px", margin: "0 auto", padding: "60px 32px 20px" }}>
      <div data-m="fluid" style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(300px,1fr))", gap: "1px", background: "rgba(26,22,20,.12)", border: "1px solid rgba(26,22,20,.12)" }}>
        ...
        <div data-m="pad" style={{ background: "#FBF9F5", padding: "32px" }}>
          ...
          <h2 style={{ font: "400 26px/1.15 'Instrument Serif',serif", margin: "0 0 10px" }}>Shipping & handover</h2>
          <p style={{ font: "400 14px/1.7 Archivo", color: "#6B6259", margin: "0" }}>Loading supervised, documents issued, container booked. You get the file your customs broker needs and a weekly position update.</p>
        </div>
      </div>
    </section>
    ...
    <section data-m="wrap fluid" style={{ maxWidth: "1260px", margin: "0 auto", padding: "52px 32px 80px", display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(300px,1fr))", gap: "20px" }}>
      <div data-m="pad" style={{ background: "#1A1614", color: "#F4F0E8", padding: "36px" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "13px" }}>
          ...
          <div style={{ display: "flex", gap: "14px", font: "400 14.5px/1.55 Archivo" }}><span style={{ font: "500 11px 'JetBrains Mono',monospace", color: "#E2857C", flex: "none", paddingTop: "3px" }}>02</span>Target landed price and target market</div>
          <div style={{ display: "flex", gap: "14px", font: "400 14.5px/1.55 Archivo" }}><span style={{ font: "500 11px 'JetBrains Mono',monospace", color: "#E2857C", flex: "none", paddingTop: "3px" }}>03</span>First-order volume and expected annual volume</div>
          <div style={{ display: "flex", gap: "14px", font: "400 14.5px/1.55 Archivo" }}><span style={{ font: "500 11px 'JetBrains Mono',monospace", color: "#E2857C", flex: "none", paddingTop: "3px" }}>04</span>Any certification you must have — CE, FDA, FCC, LFGB</div>
      ...
      <div data-m="pad" style={{ background: "#FBF9F5", border: "1px solid rgba(26,22,20,.12)", padding: "36px" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "17px" }}>
          <div>
            <div style={{ font: "600 13px Archivo", color: "#1A1614", marginBottom: "4px" }}>Me, not a shared inbox</div>
            <div style={{ font: "400 13.5px/1.6 Archivo", color: "#6B6259" }}>Same person from brief to delivery. Specialists work under me; nobody is handed your account.</div>
          </div>
          <div>
            <div style={{ font: "600 13px Archivo", color: "#1A1614", marginBottom: "4px" }}>A written update every Friday</div>
            <div style={{ font: "400 13.5px/1.6 Archivo", color: "#6B6259" }}>Progress, risks, and what needs a decision from you.</div>
          </div>
          <div>
            <div style={{ font: "600 13px Archivo", color: "#1A1614", marginBottom: "4px" }}>WhatsApp or WeChat for anything urgent</div>
            <div style={{ font: "400 13.5px/1.6 Archivo", color: "#6B6259" }}>Guangzhou hours, plus an evening window for Europe and the US.</div>
          </div>
          <div>
            <div style={{ font: "600 13px Archivo", color: "#1A1614", marginBottom: "4px" }}>Every document in one shared folder</div>
            <div style={{ font: "400 13.5px/1.6 Archivo", color: "#6B6259" }}>Quotes, contracts, reports, invoices, B/L — yours to keep.</div>
          </div>
        </div>
      </div>
    </section>
